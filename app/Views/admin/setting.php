...
<a href="<?= route_to('admin.settings.create') ?>" class="btn btn-info  m-1">Add New Question</a>
</div>
<div class=" text-center">
...
<a herf="#"  class=" btn btn-info m-1">BACK</a>
    ...
    <div class="card">
         <div class="card-header">
             ...
             <a href="<?= route_to('admin.settings.create') ?>" class="btn btn-secondary btn-sm">Add New Question</a>
                 </div>
        ...
        <tbody>
            ...
            <tr class="row">
                ...
                <td class="col-md-1 form-control text-center mr-1">
                    <a href="<?= route_to('admin.settings.edit', $question['id']) ?>"><i class="fas fa-edit"></i></a>
            </td>
             <td class="col-md-1 text-center mr-1"> 
            <form action="<?= route_to('admin.settings.destroy', $question['id']) ?>" method="post">
